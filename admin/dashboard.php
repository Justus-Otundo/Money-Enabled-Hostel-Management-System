...
<p> Brought To You By <a href="https://oscar-jus.org/">oscar-jus</p>
</footer> </div>
...
<style> .foot{
  ...
  bottom: 0;
  width: 100%;
  height: 50px; /* Adjust this value to set the height of the footer */
  background-color: #f1f1f1; /* Set your desired background color */
	text-align: center; border: 1px solid black;}</style>
